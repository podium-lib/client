...
module.exports = class State extends EventEmitter {
    constructor(registry, options = {}, reqOptions, streamThrough = true) {
        ...
        // What status the manifest are in. This is used to tell what actions needs to
        ...
        // "fresh" - the manifest have been fetched but is not stored in cache yet
        // "cached" - the manifest was retrieved from cache
        // "stale" - the manifest is outdated, a new needs to be fetched
        this._status = 'empty';
