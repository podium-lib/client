    ...
    resolve(outgoing) {
        return new Promise(resolve => {
            ...
            request(reqOptions, (error, res, body) => {
                ...
                if (manifest.value.assets.css) {
                    outgoing.stream.emit('css', manifest.value.assets.css);
                }
                ...
                if (manifest.value.assets.js) {
                    outgoing.stream.emit('js', manifest.value.assets.js);
                }
